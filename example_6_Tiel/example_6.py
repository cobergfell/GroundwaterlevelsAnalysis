...
path_to_file = os.path.join(path_to_resources_folder,'B39D0221001_1.csv')
path_to_file = os.path.join(path_to_resources_folder,'B39D2692001_1.csv')
path_to_file = os.path.join(path_to_resources_folder,'B39D2706001_1.csv')
path_to_file = os.path.join(path_to_resources_folder,'B39D2737001_1.csv')
...
mydir = os.path.join(path_to_parent_folder,'example_6_Tiel')         
...
potimizer = Poptimizer(heads = heads, time = time, p_dict = p_dict, time_step = time_step,time_step_targets = time_step_targets,
                        ...
                        analytical_jacobian = False, maxiter = 300)    
