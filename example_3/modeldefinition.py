...
class ModelDefinition:
    ...
    def __init__(self, working_directory  = None, read_from_resources = False):
        ...
        model_definition['db']['equal_to_mean_observed_heads_minus_mean_response'] = True # False #
        ...
        model_definition['evap']['number_of_regimes'] = model_definition['prec']['number_of_regimes']
        ...
        model_definition['noise']['model_residuals'] = False #True #True # False #True #False #   #noise can still be switched off in simulations options
