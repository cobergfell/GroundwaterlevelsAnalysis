    ...
    def __init__(self, working_directory  = None, read_from_resources = False):
        ...
        if model_definition['db']['mean_observed_heads_minus_mean_response'] == False:
            if model_definition['db']['fixed'] == True:
                model_definition['db']['user_entered_value'] = 1.47#0.01#11.43 # this is just an example
        ...
        model_definition['prec']['number_of_regimes'] = 1 # if > 1, response will be weighted and superposed
        model_definition['prec']['weighting'] = 'sigmoid'        
        model_definition['prec']['use_normalized_time_series'] = False #True # False # if true then add mean stress to the drainage base
        ...
        model_definition['evap']['funct_type'] = 'incomplete_gamma_f' #'floodwavemodel2L_typeI' # 
        ...
        model_definition['pump']['use_normalized_time_series'] = False # True #  if true then add mean stress to the drainage base
        ...
        model_definition['noise']['model_residuals'] = False #True #  #noise can still be switched off in simulations options
